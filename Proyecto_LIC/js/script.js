...
usuario.login = function(){
    ...
    for(var i=0;i<=cont;){
        ...
        if (usuario.estado[i]==true){
            ...
            usuario.numerocuentas[usuario.posicion_actual] = 0;
            usuario.balance[usuario.posicion_actual] = 0;
            usuario.monto[usuario.posicion_actual] = new Array;
            usuario.banco[usuario.posicion_actual] = new Array;
            usuario.ncuenta[usuario.posicion_actual] = new Array;
            usuario.saldo[usuario.posicion_actual] = new Array;
...
usuario.nuevacuentas=function(){
    ...
    j = usuario.numerocuentas[usuario.posicion_actual];
        ...
        usuario.monto[usuario.posicion_actual][j] = document.getElementById("txtmontoI").value;
...
usuario.calculo_balance=function(){
    ...
    for (var i = 0; i <= j; i++) {
        ...
        usuario.balance[usuario.posicion_actual] = parseInt(usuario.balance[usuario.posicion_actual]) + parseInt(usuario.saldo[usuario.posicion_actual][i]);
